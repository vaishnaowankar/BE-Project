...
move()
#
lbl = tk.Label(root, text="Lung cancer disease Detection using ML", font=('times', 35,' bold '), height=1, width=60,bg="maroon",fg="white")
lbl.place(x=0, y=0)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='D:/22SS137 Lungs  Cancer/lung cancer/test_set', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
